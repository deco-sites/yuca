    ...
    <div className="mx-auto max-w-4xl px-6">
      <div className="flex flex-col py-8 mt-[40px]">
        ...
        <p className="text-xl font-sans text-center">
          A Yuca conecta você às melhores oportunidades.
        </p>
      </div>
      <div className="flex gap-5 sm:flex-row flex-col">
        <div className="w-full sm:w-1/3 flex flex-col relative">
          ...
          <p className="text-sm pt-2.5">
            Vila Formosa • Rua Correia da Câmara Mobiliado • 28m² • 1 dorm
          </p>
          <p className="text-sm font-bold mt-2 mb-1">Aluguel R$ 1.706</p>
          <p className="text-sm">Total R$ 2.002</p>
        </div>
        <div className="w-full sm:w-1/3 flex flex-col relative">
          <Image
            class="object-contain w-auto rounded"
